		...
		_arsenalHeadgear = [	
			...
			"ADFU_H_OpsCore_04_AMC",
			"ADFU_H_OpsCore_05_AMC",
			"ADFU_H_OpsCore_06_AMC",
			"ADFU_H_OpsCore_07_AMC",
			"ADFU_H_OpsCore_08_AMC",
			"ADFU_H_Airframe_Cover_02_AMC",
			"ADFU_H_Airframe_Cover_03_AMC",
			"ADFU_H_Airframe_Cover_04_AMC",
			"ADFU_H_Airframe_Cover_05_AMC",
			"ADFU_H_Airframe_Cover_06_AMC"
		...
		_arsenalVests = [
			...
			"ADFU_V_TBAS_Assaulter_Belt_AMC",
			"ADFU_V_TBAS_Grenadier_AMC",
			"ADFU_V_TBAS_Grenadier_Belt_AMC",
			"ADFU_V_TBAS_Hgunner_AMC",
			"ADFU_V_TBAS_Hgunner_Belt_AMC",
			"ADFU_V_TBAS_Light_AMC",
			"ADFU_V_TBAS_Marksman_AMC",
			"ADFU_V_TBAS_Marksman_Belt_AMC",
			"ADFU_V_TBAS_Medic_AMC",
			"ADFU_V_TBAS_Medic_Belt_AMC",
			"ADFU_V_TBAS_TeamLeader_AMC",
			"ADFU_V_TBAS_TeamLeader_Belt_AMC"
