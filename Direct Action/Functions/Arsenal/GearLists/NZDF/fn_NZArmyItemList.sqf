		...
		_arsenalHeadgear = [
			...
			"ncs_nzdf_arch_mc",
			"ncs_nzdf_boonie_mc",
			"ncs_nzdf_mc_ech_helmet",
			"ncs_nzdf_mc_ech_g_helmet",
			"ncs_nzdf_mc_ech_cg_helmet",
			"ncs_nzdf_mc_ech_helmet_o",
			"ncs_nzdf_mc_ech_g_helmet_o",
			"ncs_nzdf_mc_ech_cg_helmet_o",
			"ncs_nzdf_mc_ech_camo_helmet",
			"ncs_nzdf_mc_ech_camo_helmet_o",
			"ncs_nzdf_jetpilot_helmet",
			"ncs_nzdf_pilot_helmet",
		...
		_arsenalUniforms = [
			...
			"ncs_nzdf_coverall_heli_uniform",
			"ncs_nzdf_coverall_tspt_uniform",
			"ncs_nzdf_d_coverall_tspt_uniform",
			"u_ncs_nzdf_mc_uniform",
		...
		_arsenalVests = [
			...
			"ncs_nzdf_vest_o_mc",
			"ncs_nzdf_jetpilot_vest",
			"ncs_nzdf_marciras_assaulter",
			"ncs_nzdf_marciras_hgunner",
			"ncs_nzdf_marciras_marksman",
			"ncs_nzdf_marciras_medic",
			"ncs_nzdf_marciras_teamleader",
			"ncs_nzdf_marciras_grenadier",
			"ncs_nzdf_vest_rnzaf"
