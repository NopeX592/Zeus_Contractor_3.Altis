	...
	// Vehicles
		...
		_wheeledIFV				=	"CUP_B_M1126_ICV_M2_Desert";
		...
		_plane_L3				=	"CUP_B_AV8B_DYN_USMC";
		_plane_L4				=	"CUP_B_F35B_Stealth_USMC";
		_plane_L5				= 	"CUP_B_F35B_USMC";
		_plane_L6				= 	"CUP_B_A10_DYN_USA";	
		_flag					=	"Flag_USA";
		_marker 				=	"flag_USA";
