	...
	// Units
		...
		_gunner					=	"";
		_medic					= 	"I_medic_F";
		_repairSpecialist		=	"I_Soldier_repair_F";
		_engineer				= 	"I_engineer_F";
		_guidedLAT				=	"I_Soldier_LAT_F";
		_dumbLAT				=	"I_Soldier_LAT2_F";
		_missileSpecialistAT	= 	"I_Soldier_AT_F";
		_missileSpecialistAA	=	"I_Soldier_AA_F";
		_ammoBearer				= 	"I_Soldier_A_F";
		_JTAC					= 	"";
		_explosivesSpecialist	= 	"I_Soldier_exp_F";
		_uavOperator			= 	"I_soldier_UAV_F";
		_paratrooper			=	"";
		_heliPilot 				=	"I_helipilot_F";
		_heliCrew				=	"I_helicrew_F";
		_fighterPilot			=	"I_Fighter_Pilot_F";
		_pilot					=	"I_pilot_F";
		_vehicleCrew			=  	"I_crew_F";
		_diver 					=	"I_diver_F";
		_diverTeamLeader		=	"I_diver_TL_F";
		_diverExplosives		=	"I_diver_exp_F";
	...
	// Vehicles		
		...
		_largeAH				=	"I_Heli_light_03_dynamicLoadout_F";
		_TrPlane				=	"";
		_CargoPlane				=	"";
		_plane_L1				=	"";
		_plane_L2				=	"I_Plane_Fighter_03_AA_F";
		_plane_L3				=	"I_Plane_Fighter_03_dynamicLoadout_F";
		_plane_L4				=	"I_Plane_Fighter_03_CAS_F";
		_plane_L5				= 	"";
		_plane_L6				= 	"I_Plane_Fighter_04_F";
		_flag					=	"Flag_AAF_F";
		_marker 				=	"flag_AAF";
