...
task_3_6 = player createSimpleTask ["Recapture Eastwind Device"];
	...
	task_3_6 setSimpleTaskDestination (getMarkerPos "eastwind_decoy");
...
trg_tsk_3_6_1 = createTrigger ["EmptyDetector", getMarkerPos "eastwind_decoy"];
	trg_tsk_3_6_1 setTriggerArea [75, 75, 100, false];
	trg_tsk_3_6_1 setTriggerActivation ["ANYPLAYER", "PRESENT", false];
	trg_tsk_3_6_1 setTriggerStatements ["this","",""];

while {_run_1} do {
	if (triggerActivated trg_tsk_3_6_1) then {
		trg_tsk_3_6_2 = createTrigger ["EmptyDetector", getMarkerPos "eastwind_decoy"];
			trg_tsk_3_6_2 setTriggerActivation ["JULIET", "PRESENT", false];
			trg_tsk_3_6_2 setTriggerStatements ["this","eastwind_not = true;",""];
			trg_tsk_3_6_2 setTriggerText "Report Eastwind not present";
			_run_1 = false;
			_run_2 = true;
	};
};
...
while {_run_2} do {
	if ((eastwind_not) || (task_3_1_skip)) then {
		task_3_6 setTaskState "Cancelled";
